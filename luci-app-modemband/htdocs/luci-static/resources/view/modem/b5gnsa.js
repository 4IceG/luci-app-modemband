...
function updateTileColorsFromEnabled5gnsa(enabledArray) {
    try {
        ...
        console.log('updateTileColorsFromEnabled5gnsa error:', e);
    }
}
...
return view.extend({
    ...
    render: function (data) {
        ...
        s.render = L.bind(function (view, section_id) {
            if (json && json.enabled5gnsa && json.supported5gnsa) {
        ...
        s.anonymous = true;
        s.addremove = false;
        this._settingsSection = s;

        if (json && json.supported5gnsa && json.enabled5gnsa) {
